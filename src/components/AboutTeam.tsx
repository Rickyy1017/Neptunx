...
/* ---------------- Partners ---------------- */
const partners = [
  { name: "LG", logo: lgLogo, slug: "lg" },
  { name: "Hisense", logo: hisenseLogo, slug: "hisense" },
  { name: "Panasonic", logo: panasonicLogo, slug: "panasonic" },
  { name: "Midea", logo: mideaLogo, slug: "midea" },
];
            ...
            <Reveal key={p.name} delay={i * 90}>
              ...
              >
                ...
                <img
                  ...
                  style={{ animationDelay: `${i * 900}ms` }}
                />
                <span className="absolute bottom-2 text-[10px] uppercase tracking-[0.16em] text-muted-foreground opacity-0 group-hover:opacity-100 transition">
                  View products
                </span>
              </Link>
            </Reveal>
